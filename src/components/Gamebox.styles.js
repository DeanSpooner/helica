...
const ClickIcon = styled.img`
  ...
  padding: 4px;
  ${(props) =>
    props.red && `transform: rotate(90deg); animation: pulsingRed infinite 2s`}
  ${(props) =>
    props.blue &&
    `transform: rotate(90deg) scaleY(-1); animation: pulsingBlue infinite 2s`}
`;
...
const HealthMeter = styled.meter`
  color: red;
  width: 50%;
`;
